package com.briup.crm.customer.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.briup.crm.customer.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("swagger在线API")
                .description("欢迎访问github.com/1ceDove")
                .termsOfServiceUrl("github.com/1ceDove")
                .version("1.0")
                .build();
    }
